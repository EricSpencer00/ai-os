...
if wait_for_agent; then
  ...
  if fetch_screenshot "${OUT}"; then
    ...
    if fetch_screenshot "/tmp/auraos_debug_retry.png"; then
      ...
      echo
  echo "--- /home/${AURAOS_USER:-ubuntu}/xfce_start.log (tail 200) ---"
  multipass exec "$INSTANCE" -- sudo sh -c "test -f /home/${AURAOS_USER:-ubuntu}/xfce_start.log && tail -n 200 /home/${AURAOS_USER:-ubuntu}/xfce_start.log || echo 'no xfce_start.log'" || true
      echo
